...
%             behaviorTemp.(sess(ii).name)= behaviorOpenField('verbose',verbose);
        ...
        elseif strcmpi(tracking.apparatus.name,'linearTrack') | strcmpi(tracking.apparatus.name,'Linear Track  N-S')
        ...
        elseif strcmpi(tracking.apparatus.name,'Object Recognition') 
            behaviorTemp.(sess(ii).name) = behaviorOpenField('verbose',verbose,'tracking',tracking);
        end
