...
%         lin{ii} = [behaviorTemp.(efields{ii}).position.lin];
%         armMask{ii} = [behaviorTemp.(efields{ii}).masks.arm];
%         trialMask{ii} = [behaviorTemp.(efields{ii}).masks.trials];
%         recMask{ii} = [ii * ones(size(behaviorTemp.(efields{ii}).masks.trials))];
%         startPoint{ii} = [behaviorTemp.(efields{ii}).events.startPoint + preRec];
%         rReward{ii} = [behaviorTemp.(efields{ii}).events.rReward + preRec];
%         lReward{ii} = [behaviorTemp.(efields{ii}).events.lReward + preRec];
%         startDelay{ii} = [behaviorTemp.(efields{ii}).events.startDelay + preRec];
%         endDelay{ii} = [behaviorTemp.(efields{ii}).events.endDelay + preRec];
%         intersection{ii} = [behaviorTemp.(efields{ii}).events.intersection + preRec];
%         recordings{ii} = [preRec];
%         startPointTrials{ii} = [behaviorTemp.(efields{ii}).trials.startPoint + preRec];
%         endDelayTrials{ii} = [behaviorTemp.(efields{ii}).trials.endDelay + preRec];
%         visitedArm{ii} = [behaviorTemp.(efields{ii}).trials.visitedArm];
%         choice{ii} = [ behaviorTemp.(efields{ii}).trials.choice];
%         expectedArm{ii} = [behaviorTemp.(efields{ii}).trials.expectedArm];
%         direction{ii} = [ behaviorTemp.(efields{ii}).masks.direction];
%         trialsDirection{ii} = [behaviorTemp.(efields{ii}).masks.trialsDirection'];
%         recordingsTrial{ii} = [ii*ones(size(behaviorTemp.(efields{ii}).trials.startPoint,1),1)];
%         description{ii} = behaviorTemp.(efields{ii}).description;
%     end
% else
%     warning('Number of behavioral recordings do not match!')
