...
if length(SHANKS)> 9 | probesNumber > 1
    ...
    if Seperate_Probs==1
        ...
        CorticalChannel_included=input('Are cortical channels included in the above groups (if yes press 1 else press 0) ');
...
if ~isempty(timestamps_subSession)
    ...
    [lfp] = bz_GetLFP('all','conversion',false,'notch',false);
end
