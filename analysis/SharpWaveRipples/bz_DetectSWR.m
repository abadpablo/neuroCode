...
% I changed the LoadXml function by LoadXml_old ( to use the
% LoadParameteres instead) beacuase was having problems with the xmltools
% function ( ABAD)  
par        = LoadXml_old( [Filebase '.xml'] );
