function [GMI] = bz_GMITort_NP(lfp,phaserange,amprange,varargin)
...
if showFig
    if length(phaseCh) == 1 && length(ampCh) == 1
        ...
        if saveFig
            if ~isempty(foldername)
                saveas(gcf,['lfpAnalysisFigures\GMI_Tort_v1.',foldername,'_',num2str(amprange(1)), num2str(amprange(end)),'_',num2str(times(1)),'-',num2str(times(end)),'.png'])
            else
    ...
    elseif length(phaseCh) == sessionInfo.nChannels
        ...
        if saveFig
            if ~isempty(foldername)
                saveas(gcf,['lfpAnalysisFigures\GMI_Tort_v1_allCh.',foldername,'_',num2str(amprange(1)),num2str(amprange(end)),'_',num2str(times(1)),'-',num2str(times(end)),'.png'])
            else
