function [frequencyBands] = bz_extractFrequencyBands_NP(a,varargin)
...
elseif strcmpi(variable,'coherogram')
    if analyzeSubSessions
        ...
        for ii=1:length(MergePoints.foldernames)
            for jj = 1:length(a.(MergePoints.foldernames{ii}))
                coherogram = a.(MergePoints.foldernames{ii}){jj}.coherogram;
                phase = a.(MergePoints.foldernames{ii}){jj}.phase;
                t = a.(MergePoints.foldernames{ii}){jj}.t;
                f = a.(MergePoints.foldernames{ii}){jj}.f;
                S1 = a.(MergePoints.foldernames{ii}){jj}.S1';
                S2 = a.(MergePoints.foldernames{ii}){jj}.S2';
                ch1 = a.(MergePoints.foldernames{ii}){jj}.ch1;
                ch2 = a.(MergePoints.foldernames{ii}){jj}.ch2;
                ...
                frequencyBands.(MergePoints.foldernames{ii}){jj}.coherence_mean = coherence_mean;
                frequencyBands.(MergePoints.foldernames{ii}){jj}.phase_mean = phase_mean;
                frequencyBands.(MergePoints.foldernames{ii}){jj}.S1_mean = Eband_S1_mean;
                frequencyBands.(MergePoints.foldernames{ii}){jj}.S2_mean = Eband_S2_mean;

                frequencyBands.(MergePoints.foldernames{ii}){jj}.coherence = coherence;
                frequencyBands.(MergePoints.foldernames{ii}){jj}.phase = phase;
                frequencyBands.(MergePoints.foldernames{ii}){jj}.S1 = Eband_S1;
                frequencyBands.(MergePoints.foldernames{ii}){jj}.S2 = Eband_S2;

                frequencyBands.(MergePoints.foldernames{ii}){jj}.ch1 = ch1;
                frequencyBands.(MergePoints.foldernames{ii}){jj}.ch2 = ch2;
            end
        end
    else
        coherogram = a.coherogram;
